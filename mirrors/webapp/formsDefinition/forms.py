...
class ManagementForm(forms.Form):
    ...
    interval = forms.IntegerField(error_messages={'required': 'Wprowadź interwał odczytu temperatury (przywrócono poprzednią wartość)', 'max_value': 'Czas interwału musi być z zakresu 0-300 sekund', 'min_value': 'Czas interwału musi być z zakresu 0-300 sekund'}, required=True, min_value = 0, max_value=5)